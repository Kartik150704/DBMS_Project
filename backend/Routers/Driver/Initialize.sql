...
DELIMITER / / CREATE PROCEDURE InsertDriver(
...
DELIMITER / / CREATE PROCEDURE book_ride(
    IN driverId_param VARCHAR(50),
    IN customerMobileNumber_param VARCHAR(50)
) BEGIN DECLARE driverName_val VARCHAR(50);
